...
echo "bcftools view $vcfFile -r scaffoldA$ii -o A$ii.snp.vcf" >> snpcmd.sh
...
echo "bcftools view $vcfFile -r scaffoldC$ii -o C$ii.snp.vcf" >> snpcmd.sh
done
