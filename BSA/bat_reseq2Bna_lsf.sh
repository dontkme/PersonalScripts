...
echo "#BSUB -J $short.2Bna" >$short.lsf
...
echo "hisat2 -p 4 -x $reffa -1 $file1 -2 $file2 --no-spliced-alignment -S ${short}.sam" >>$short.lsf
...
echo "echo \"$short DNA hisat2 $reffa  done.\" " >>$short.lsf
