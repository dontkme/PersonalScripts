...
echo "#PBS -N callisnpall" >$OUTpbsname
...
echo "samtools mpileup -f $refgenome ${ma[*]} |java -jar /public/home/knhu/biosoft/VarScan.v2.3.7.jar mpileup2snp -output-vcf 1 >$name.allsnp.vcf" >>$OUTpbsname
