...
echo "#BSUB -J callsnpall" >$OUTpbsname
...
echo "samtools mpileup -f $refgenome ${ma[*]} |java -jar /public/home/knhu/biosoft/VarScan.v2.4.4.jar mpileup2snp --vcf-sample-list namelist.txt -output-vcf 1 >$name.allsnp.vcf" >>$OUTpbsname
