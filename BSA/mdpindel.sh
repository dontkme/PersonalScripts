...
echo "samtools mpileup -f $refgenome ${ma[*]} |java -jar /public/home/knhu/biosoft/VarScan.v2.4.2.jar mpileup2indel --vcf-sample-list namelist.txt --output-vcf 1 >$name.allindel.vcf" >>$OUTpbsname
