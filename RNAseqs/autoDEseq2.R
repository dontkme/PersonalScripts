#### auto DESeq2.R v1.1 write by Hu Kaining. 2021-11-18 v1.1
#### hukaining@gmail.com
autoDESeq2 <- function(I,C,n){
    ...
    write.table(sizeFactors(dds),"sizefactors.txt",col.names = NA)
    ...
    autoPCA <- function(n){
        compicname<-"PCA"
        write.table(plotPCA(rld,intgroup="Group",ntop=n,returnData=T),"PCA.txt",sep="\t",col.names = NA)
