...
ncpu=4
jobname="$short.cutAdptPolyA"
sbatchname="$short.cutAdptPolyA.sbatch"
...
echo "zcat $short.trim5_polyA.fq.gz |awk 'NR%4==2{print length($1)}' |sort |uniq -c >$short.trim5_polyA.fq.summary" >>$sbatchname
